...
*/
    ...
    var wr, _r = "[data-newsletter]", xr = "[data-newsletter-close]", Sr = "[data-newsletter-trigger]", Tr = "is-overlay-opened", Cr = ".popup__messages", kr = ".popup__success-message", Er = ".popup__error-message", Ar = document.querySelector(_r);
    if (Ar) {
        var Dr = window.localStorage
          , Lr = document.querySelectorAll(xr)
          , Pr = document.querySelectorAll(Sr)
          , Mr = (document.querySelector(Cr),
        bi()(kr))
          , Or = bi()(Er)
          , jr = function() {
          ...
          , Hr = function() {
            ...
            Or.css("display", "none"),
            Or.html(""),
            bi()("#email_signup_popup").trigger("reset"),
            bi()(".popup__field-group").css("display", "block"),
            bi()(".popup__form-actions").css("display", "block")
        };
            ...
            if ("" !== e)
                if (function(t) {
                    ...
                    bi.a.ajax(n).done((function(t) {
                        t.success ? t.data.is_subscribed ? zr(Or, "This email address has already subscribed.") : (Mr.css("display", "block"),
                        Or.css("display", "none"),
                        bi()(".popup__field-group").css("display", "none"),
                        bi()(".popup__form-actions").css("display", "none"),
                        Dr.setItem("v_popup_s", "true")) : zr(Or, "Invalid Email Address.")
                    }
                    ))
                } else
                    zr(Or, "Invalid Email Address.");
            else
                zr(Or, "Email Address Required.");
            return !1
        }
        )),
        Lr.forEach((function(t) {
            t.addEventListener("click", (function() {
                ...
                bi()("body").removeClass(Tr),
                Hr(),
                Dr.setItem("v_popup_e", "true")
            }
            ))
        }
        )),
        ...
        if (null === $r || !1 === $r) {
            ...
            null !== qr && !1 !== qr || (wr = function(t) {
                ...
                null !== e && !1 !== e || jr(),
                !t.toElement && !t.relatedTarget && t.clientY < 5 && console.log("1")
            }
            ,
            setTimeout((function() {
            ...
            function() {
                var t, e, n, i;
                function r() {
                    t = window.innerHeight || (document.documentElement || document.body).clientHeight,
